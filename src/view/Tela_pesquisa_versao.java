 ...
 * @author mahsa
 */
public class Tela_pesquisa_versao extends javax.swing.JDialog {

    /**
     * Creates new form Tela_pesquisa_versao
     */
    public Tela_pesquisa_versao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void setjT_listaMarca(JTable jT_listaMarca) {
        this.jT_listaMarca = jT_listaMarca;
    }
    ...
    private void initComponents() {
        ...
        jT_listaMarca.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Modelo", "Versão", "Potência", "Portas", "Lugares", "Câmbio", "Consumo"
            }
        ) {
        ...
        jLabel1.setText("Lista de versões dos veículos");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel1, javax.swing.GroupLayout.DEFAULT_SIZE, 1305, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_pesquisa_versao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tela_pesquisa_versao dialog = new Tela_pesquisa_versao(new javax.swing.JFrame(), true);
