 ...
 * @author Aluno
 */
public class Tela_pesquisa_modelo extends javax.swing.JDialog {

    /**
     * Creates new form Tela_pesquisa_modelo
     * @param parent
     * @param modal
     */
    public Tela_pesquisa_modelo(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public JTable getjT_listaModelo() {
        return jT_listaModelo;
    }
    ...
    private void initComponents() {
        ...
        jT_listaModelo = new javax.swing.JTable();
        ...
        jT_listaModelo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Modelo", "Categoria", "Tipo", "Marca"
            }
        ));
        jScrollPane1.setViewportView(jT_listaModelo);
        if (jT_listaModelo.getColumnModel().getColumnCount() > 0) {
            jT_listaModelo.getColumnModel().getColumn(0).setResizable(false);
            jT_listaModelo.getColumnModel().getColumn(1).setResizable(false);
            jT_listaModelo.getColumnModel().getColumn(2).setResizable(false);
            jT_listaModelo.getColumnModel().getColumn(3).setResizable(false);
            jT_listaModelo.getColumnModel().getColumn(4).setResizable(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_pesquisa_modelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tela_pesquisa_modelo dialog = new Tela_pesquisa_modelo(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jT_listaModelo;
